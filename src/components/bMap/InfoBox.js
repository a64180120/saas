/**
import default from './../utils/util';
...
;(function() {
    ...
    ;(function() {
        ...
        baidu.browser.ie = baidu.ie = /msie (\d+\.\d+)/i.test(
            navigator.userAgent
        )
     ...
     * @constructor
         ...
         * <br />"<b>closeIconClass</b>" : {String} 定义关闭图片的class，覆盖infoBox-close<br />
     ...
     */
        (BMapLib.InfoBox = function(map, content, opts) {
            ...
            this._opts.closeIconClass = opts.closeIconClass || 'infoBox-close'
            this._opts.closeIconMargin = opts.closeIconMargin || '2px'
            let defaultCloseImg =
                'data:image/png;base64,'
            this._opts.closeIconUrl = opts.closeIconUrl || defaultCloseImg //定义关闭按钮图片路径
            this._opts.enableAutoPan = opts.enableAutoPan ? true : false
            this._opts.align = opts.align || INFOBOX_AT_TOP
            this._opts.clickOnBox = opts.clickOnBox || function() {}
        })
     ...
     * infoBox.close();
     */
    InfoBox.prototype.close = function(e) {
        this._stopBubble(e)
        if (this._isOpen) {
        ...
        baidu.object.extend(InfoBox.prototype, {
            ...
            _getCloseIcon: function() {
                var img =
                    ...
                    "' align='right' style='position:absolute;right:0px;top:0;cursor:pointer;margin:" +
                    this._opts.closeIconMargin +
                    "' class='" +
                    this._opts.closeIconClass +
                    "'/>"
                return img
            },
            /**
