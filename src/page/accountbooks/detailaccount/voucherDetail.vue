<template>
    ...
    <div class="voucher" style="z-index:1">
            ...
            <ul class="flexPublic">
                ...
                <li>
                    <div class="block">
                        ...
                        <span>{{PDate.substring(0,10)}}</span>
                        <!--<el-date-picker
                            v-model="PDate"
                            type="date"
                            :disabled="true"
                ...
                <li class="flexPublic">
                    ...
                    <div class="fileContainer" ><div>附单据&nbsp;</div><div class="inputContainer"><input type="text" style="text-align: center" v-model="PAttachment" disabled></div><div>&nbsp;张&nbsp;</div><div style="clear:both"></div></div>
                </li>

            </ul>
        </div>
        <div  class="voucherContent" :disabled="true">
            <div v-show="moneyInputMask" class="moneyInputMask"></div>
            ...
            <ul>
                <li>
                    <ul class="flexPublic voucherContentItem">
                        ...
                        <li>科目</li>
                        <li>
                            <div><div v-if="fatherData.Verify==1" class="auditZhang"><img src="@/assets/images/zhang.png" alt=""></div>借方金额</div>
                    ...
                    <ul  class="flexPublic voucherContentItem">
                        ...
                        <li class="abstractContainer">
                            <div class="inputContainer" >
                                <textarea disabled :class="{chongHcss:AbstractCss=='冲红',gengZcss:AbstractCss=='更正'}" v-model="item.Abstract" maxlength="50"></textarea>
                            </div>
                            <div class="abstractSearch">
                                <ul  v-show="addIcon[index].checked&&AbstractAContents.length>0">
                                    <li  :title="abs.AContent" v-for="(abs,indAbstract) of AbstractAContents " :key="indAbstract">{{abs.AContent}}</li>
                                </ul>
                                <div></div>
                            </div>
                        ...
                        <li class="kemu">
                            <div>
                                <ul>
                                    ...
                                    <li v-show="kemuSel[index].checked" class="kemuCancle"><i></i></li>
                                </ul>
                            </div>
                        </li>
                        <li class="flexPublic money">
                            <span :class="{moneyInputShow:item.moneyInput.jiefang}" class="moneyValCon">
                                <input type="text"  v-model="item.money.jiefang" placeholder="请输入金额"
                                       onkeyup="this.value=this.value.replace(/e/g,'')" onafterpaste="this.value=this.value.replace(/e/g,'')" >
                                <i @click.stop="moneyCancle(item,'jiefang',$event)" class="inputCancle">X</i>
                             </span>
                            <div></div>
                            <div></div>
                            <div></div>
                        ...
                        <li  class="flexPublic money">
                            <span :class="{moneyInputShow:item.moneyInput.daifang}" class="moneyValCon">
                                <input type="text"  v-model="item.money.daifang"  placeholder="请输入金额">
        ...
        <el-dialog title="附件"  :visible.sync="picVisible" :modal=false width="40%" style="overflow-y: auto">
            <template v-if="imglist.length==0">当前不存在附件</template>
            <template v-else>
                <template v-for="item in imglist">

                    <img :src="picUrl+item.BUrlPath">
                </template><!--
                <picture-upload :imgList="imglist"></picture-upload>-->
            </template>

            <!--<picture-upload :imgList="imglist" :limit="3"></picture-upload>-->
        </el-dialog>
...
<script>
    ...
    import addSubList from '../../finance/addSubList'
    import searchSelect from '../../finance/searchSelect'
    ...
    import PictureList from "../../admin/picture/index";
    export default {
        name: "voucherDetail",
        props:{
            'dataList':Object,
        ...
        methods:{
            ...
            getVoucherData(data){
                ...
                if(this.voucherInfo.length<4){
                    var leng=4-this.voucherInfo.length;
