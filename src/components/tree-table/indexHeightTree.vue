<template>
  ...
  @current-change="handleCurrentChange">
    ...
    <el-table-column class="clear-indexHeight-icon" v-if="columns.length===0" width="64" label="序号">
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  /*.clear-indexHeight-icon  .cell .el-table__expand-icon{*/
  /*    display: none;*/
  /*}*/
</style>
