        ...
        <el-tab-pane :label="`基层工会组织`"
          ...
          <app-toolbar>
            <el-button type="info"
                       ...
                       @click="orgDataAdd">新增</el-button>
            <el-button type="info"
                       icon="el-icon-lx-add"
                       size="small"
                       class="handle-del mr10"
                       @click="orgDataEdit">修改</el-button>
          ...
          <!--基层工会组织 表格体 -->
          <el-table v-loading="orgData.loading"
                    :data="orgData.data"
                    class="table"
                    ref="organizeTable"
            ...
            <el-table-column label="账套">
              ...
              <el-table-column prop="Creator"
                               label="创建人"
                               width="100"> </el-table-column>
              <el-table-column prop="kuaiji"
                               label="会计"
                               width="100"> </el-table-column>
            </el-table-column>
            <el-table-column prop="EnabledMark"
                             width="80"
                             label="启用/停用"></el-table-column>
            <el-table-column prop="ServiceEndTime"
                             width="100"
                             label="服务期限"></el-table-column>
          </el-table>
          <div class="pagination">
            <el-pagination background
                           @current-change="orgDataPageChange"
                           layout="total,prev, pager, next"
                           :page-size="orgData.pageSize"
                           :total="orgData.totalCount">
            </el-pagination>
          </div>
        </el-tab-pane>
        <el-tab-pane :label="`机关工会组织`"
                     name="second">
          <template v-if="message === 'second'">
            ...
            <app-toolbar>
              ...
              <el-button type="primary"
                         v-hasPermission="'edit'">修改</el-button>
              <el-button type="primary">备份</el-button>
              <el-button type="primary">恢复</el-button>
              <el-button type="primary">导入</el-button>
            </app-toolbar>
            ...
            <!--机关工会组织 表格体 -->
            <el-table v-loading="AdminOrgData.loading"
              ...
              <el-table-column type="index"
                               ...
                               width="64"
                               align="center"></el-table-column>
              <el-table-column prop="PhId"
                               label="用户号"
                               width="120"></el-table-column>
              <el-table-column prop="EnCode"
                               label="组织编码"></el-table-column>
              <el-table-column prop="OrgName"
                               label="组织名称"></el-table-column>
              <el-table-column prop="NgInsertDt"
                               width="100"
                               label="创建日期"></el-table-column>
            </el-table>
            <div class="pagination">
              <el-pagination background
                             @current-change="adminOrgDataPageChange"
                             layout="total,prev, pager, next"
                             :page-size="AdminOrgData.pageSize"
                             :total="AdminOrgData.totalCount">
              </el-pagination>
            </div>
          </template>
        </el-tab-pane>
        <el-tab-pane :label="`待审核基层组织(${verifyOrgData.totalCount})`"
                     name="third">
          <template v-if="message === 'third'">
            ...
            <el-tabs type="border-card">
              <el-tab-pane label="待审核">
                ...
                <!--待审核 表格体 -->
                <el-table v-loading="verifyOrgData.loading"
                  ...
                  <el-table-column prop="UserName"
                                   label="联系人姓名"></el-table-column>
                  <el-table-column prop="MobilePhone"
                                   label="联系电话"></el-table-column>
                  <el-table-column prop="Address"
                                   label="联系地址"></el-table-column>
                  <el-table-column prop="Integrity"
                                   label="信息完整度（%）">
                    <template slot-scope="scope">
                      <el-progress :text-inside="true"
                                   :stroke-width="18"
                                   :percentage="scope.row.Integrity"></el-progress>
                    </template>
                  </el-table-column>
                  <el-table-column prop="Tryout"
                                   label="距试用结束时长"></el-table-column>
                </el-table>
                <div class="pagination">
                  <el-pagination background
                                 @current-change="verifyOrgDataPageChange"
                                 layout="total,prev, pager, next"
                                 :page-size="verifyOrgData.pageSize"
                                 :total="verifyOrgData.totalCount">
                  </el-pagination>
                </div>
              </el-tab-pane>
              <el-tab-pane label="审核不通过">
                <!--审核不通过 表格体 -->
                <el-table v-loading="NotVerifyOrgData.loading"
                ...
                <div class="pagination">
                  <el-pagination background
                                 @current-change="NotVerifyOrgDataPageChange"
                                 layout="total,prev, pager, next"
                                 :page-size="NotVerifyOrgData.pageSize"
                                 :total="NotVerifyOrgData.totalCount">
                  </el-pagination>
                </div>
              </el-tab-pane>
            </el-tabs>
