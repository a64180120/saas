      ...
      <div class="manageContent"
        ...
        <div class="reportBox">
          <div class="">
            <ul class="flexUl"
              ...
              <div style="display: inline-block;width: 100px;vertical-align: bottom; text-align: center;">
                <el-select placeholder="剔除条件"
                           ...
                           style="width: 100px;">
                  <el-option value="0">
                    <el-checkbox v-model="showBqList.allZero"
                                 @change="dispart('allZero')">剔除本月数及本年累计数均为0</el-checkbox>
                  </el-option>
                  <el-option value="1">
                    <el-checkbox v-model="showBqList.benyueZero"
                                 @change="dispart('benyueZero')">剔除本月数为0，且本年累计数不为0</el-checkbox>
                  </el-option>
                  <el-option value="2">
                    <el-checkbox v-model="showBqList.bennianZero"
                                 @change="dispart('bennianZero')">剔除本年累计数为0，且本月数不为0</el-checkbox>
                  </el-option>
                  <el-option value="3">
              ...
              <div style="margin-left: 0px;vertical-align: bottom; display: inline-block;width: 100px;text-align: center;">
                <el-select value="剔除条件"
                           style="width: 100px;"
                           v-model="carryOver">
                  <el-option value="0"
                             label="结转前">结转前</el-option>
                  <el-option value="1"
                             label="结转后">结转后</el-option>
                </el-select>
              </div>
            ...
            <ul class="flexUl">
              <li v-if="Roleauthorize.incomeExpenses_export!=0"
                  @click="postBalanceSheetExcel">导出</li>
              <li v-if="Roleauthorize.incomeExpenses_print!=0"
          ...
          <div class="formData">
              ...
              <table ref="printFrom">
                ...
                <tbody>
                  <template v-for="item in inMoney">
                    <tr>
                      <td :class="{bolder:item.flag,center:(item.KCode=='三、本期结余')}"
                          :style="{'text-indent':(item.KCode=='三、本期结余'?'0px':'20px')}">{{item.KCode}}</td>
                      <td :class="{bolder:item.flag,'center':item.flag}"
                          style="text-indent: 30px">{{item.KName}}</td>
                      <td class="right">
                    ...
                    <template v-if="item.children.length>0">
                      <tr v-for="n in item.children">
                        <td :class="{bolder:item.flag}"
                            style="text-indent: 35px">{{n.KCode}}</td>
                        <td :class="{bolder:item.flag,'center':item.flag,'left':item.flag}"
                            style="text-indent: 30px">{{n.KName}}</td>
            ...
            <table style="display: none">
              ...
              <div id="theadArea">
                <tr>
                  <td colspan="4"
                      style="background-color: #fff;font-weight: bolder;font-size: 20px;border: 0;height: 30px">收入支出表</td>
                </tr>
                <tr>
                  <td colspan="2"
                      class="left"
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <span style="width: 50%;display: inline-block">
                      <input disabled
                             type="checkbox"
                             :checked="showBqList.allZero"> 剔除本月数及本年累计数均为0
                    </span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colspan="3">
                    <span style="width: 50%;display: inline-block;float: left">
                      <input disabled
                             type="checkbox"
                             :checked="showBqList.benyueZero"> 剔除本月数为0，且本年累计数不为0
                    </span>
                    <span style="width: 50%">
                      <input disabled
                             type="checkbox"
                             :checked="showBqList.bennianZero"> 剔除本年累计数为0，且本月数不为0
                    </span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colspan="3">
                    <span style="width: 50%;display: inline-block;float: left">
                      <input disabled
                             type="checkbox"
                             :checked="carryOver==0"> 结转前
                    </span>
                    <span style="width: 50%">
                      <input disabled
                             type="checkbox"
                             :checked="carryOver==1"> 结转后
                    </span>
                  </td>
                </tr>
