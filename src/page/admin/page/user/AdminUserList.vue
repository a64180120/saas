...
export default {
      ...
      tableData: [
        {
          ...
          Gender: 0,
          IsManage: 0,
          NgInsertDt: "2018-11-06T11:34:40",
          NgRecordVer: 1,
          NgUpdateDt: "2018-11-06T11:34:40",
          PersistentState: 0,
          PhId: 121181106000001,
          SortCode: 0,
          Type: 0,
          Verify: 0
        },
        {
          ...
          Gender: 0,
          IsManage: 0,
          NgInsertDt: "2018-11-06T11:34:43",
          NgRecordVer: 1,
          NgUpdateDt: "2018-11-06T11:34:43",
          PersistentState: 0,
          PhId: 121181106000002,
          SortCode: 0,
          Type: 0,
          Verify: 0
        }
  ...
  methods: {
    ...
    getData() {
      this.loading = true;
      this.$axios.get("http://10.0.20.46:8028/api/GCW/SysUser/GetSysUserList", {
          params: {
