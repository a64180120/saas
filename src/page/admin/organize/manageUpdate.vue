    ...
    <div class="addFormContainer">
      ...
      <ul class="addFormItems ul-flexChild">
        <li>
          ...
          <div class="inputContainer"><input disabled  @blur="unionInput(true)" type="text"  v-model="OrgName"></div>
          <div v-show="unionCss.name">请输入工会名称</div>
        </li>
        <li>
          <div class="addFormItemTitle">统一社会信用代码</div>
          <div class="inputContainer"><input disabled  @blur="unionInput(false)" type="text"   v-model="EnterpriseCode"></div>
